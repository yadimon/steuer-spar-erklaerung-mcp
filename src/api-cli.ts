...
const usage = [
  ...
  "--discardChanges true einen Wahrheitswert.",
  "",
  "Soll eine Zahl als Zeichenkette ankommen, haengt die noetige Schreibweise von",
  "der Shell ab: Windows PowerShell 5.1 entfernt die Anfuehrungszeichen aus",
  "--name '\"2024\"' und liefert die Zahl, PowerShell 7 reicht sie durch. Wer",
  "einen Typ sicher erzwingen will, nimmt --args-file.",
  "",
  "Zwei weitere Dinge dabei wissen: Werte in der Kommandozeile landen im Verlauf",
  "der Shell - PowerShell schreibt ihn dauerhaft mit -, und nicht-ASCII geht",
  "durch die Codepage der Shell. Fuer Umlaute und fuer alles, was nicht im",
  "Verlauf stehen soll, ist --args-file der verlaessliche Weg.",
  "",
