...
| BelegManager-Zustandsindex | `powershell -File test/receipt-manager-action-contract.ps1` | ordinale Suffixe, Sichtbarkeit, deaktivierte und doppelte Treffer, Überlappungen, exakter Fingerprint, Node-Identität sowie Altparität für gerichtete und 32 deterministische Fälle. Bei 800 synthetischen Knoten sank der Median der Projektion von 61,4 auf 4,5 ms (13,6×) | der davor liegende reale UIA-Walk; andere Qt-/Produktversionen; Performance bleibt ohne fragilen CI-Grenzwert |
