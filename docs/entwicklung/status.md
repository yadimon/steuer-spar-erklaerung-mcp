...
| Seiten (`.dialog`-Dateien) | 672 | **alle lesbar**, mit sichtbarem Vordergrund auch beschreibbar; 13 katalogisiert – siehe unten |
| Menueeintraege | 64 | 11 fertig, 9 teils, 4 zu |
| Formularvorlagen (`.frb`) | 994 | 0 |
| Operationen | – | 100, davon 94 live belegt |

## Was „13 katalogisierte Seiten" wirklich heisst
...
| --- | --- | --- | --- | --- |
| Einkommensteuer | `.ESt2025` | 9 | **teils** – Hauptmodul der Live-Reisen, 5 Seitenobjekte | Seiten profilieren |
