...
assert.equal(result.liveEvidence.functionalCount, 91);
assert.equal(result.liveEvidence.errorPathOnlyCount, 7);
assert.equal(result.liveEvidence.untestedCount, 1);
assert.deepEqual(result.liveEvidence.untestedOperations, ["fill_fields"]);
