...
// 99 operationsspezifische Result-Schemas mit den realen stabilen Worker-
// Feldern brauchen rund 334 KiB. Die Grenze soll versehentlich verdoppelte
// Schemas fangen - das kostet zweistellige KiB - und nicht schon bei einem
// zusaetzlichen Beschreibungssatz zuschlagen.
assert(Buffer.byteLength(serialized, "utf8") < 340 * 1024, "OpenAPI-Dokument ist unnoetig gross.");
