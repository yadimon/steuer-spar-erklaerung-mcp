...
export const parallelSteps = Object.freeze([
  ...
  nodeFile("portable-archive-verification", "test/portable-archive-verification.mjs"),
  nodeFile("portable-release-verification", "test/portable-release-verification.mjs"),
