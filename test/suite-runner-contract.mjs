...
const expectedNames = [
  "native-build", "typescript-build", "suite-runner-contract", "public-skills", "repository-privacy", "repository-links", "javascript-syntax", "powershell-syntax", "product-profiles", "page-objects-parity", "product-profile-status", "profile-operation-policy",
  "akad-parser", "case-file", "setup-wizard", "atomic-files", "jsonl-logger", "portable-package", "npm-package", "portable-zip", "workspace-containment",
  "resource-references", "live-script-resource-contract", "backup-cases-contract", "backup-local-parity", "archive-cases-synthetic", "archive-local-parity", "sse-process-guard", "setup-task", "api-contract", "checker-open-contract", "api-discovery-contract", "api-openapi-contract", "api-cli-contract", "api-config-contract", "api-all-operations", "launch-orchestration", "operation-schema-catalog", "operation-coverage-merge", "operation-result-shape-merge", "operation-trace", "live-profile-read-coverage", "live-core-read-contract", "result-contract", "result-field-worker-guard", "source-architecture", "no-year-conditionals", "mcp-module-boundaries", "mcp-main-contract",
...
for (const required of [
  ...
  "case-file", "live-script-resource-contract", "sse-process-guard",
]) {
