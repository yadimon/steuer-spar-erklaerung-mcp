...
const expectedNames = [
  "dist-prune", "native-build", "typescript-build", "npm-package-build", "agent-plugin-build", "api-docs", "docs-consistency", "publishable-dependency-parity", "obstruction-window", "known-page-state", "suite-runner-contract", "public-skills", "repository-privacy", "repository-links", "readme-contract", "github-workflow", "javascript-syntax", "powershell-syntax", "product-profiles", "page-objects-parity", "product-profile-status", "profile-operation-policy", "receipt-interaction-policy", "belegmanager-config-isolation", "api-mega-contract",
