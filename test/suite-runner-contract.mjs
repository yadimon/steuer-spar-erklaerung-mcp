...
const expectedNames = [
  "dist-prune", "native-build", "typescript-build", "suite-runner-contract", "public-skills", "repository-privacy", "repository-links", "javascript-syntax", "powershell-syntax", "product-profiles", "page-objects-parity", "product-profile-status", "profile-operation-policy",
  "akad-parser", "case-file", "setup-wizard", "atomic-files", "jsonl-logger", "dist-artifacts", "portable-package", "npm-package", "portable-zip", "workspace-containment", "workspace-file-cancellation",
  "resource-references", "live-script-resource-contract", "backup-cases-contract", "backup-local-parity", "archive-cases-synthetic", "archive-local-parity", "sse-process-guard", "setup-task", "api-contract", "api-client-body-abort", "api-client-transport-timeout", "api-local-http-transport", "checker-open-contract", "api-discovery-contract", "api-openapi-contract", "api-cli-contract", "api-config-contract", "api-all-operations", "launch-orchestration", "operation-schema-catalog", "operation-coverage-merge", "verification-doc-coverage", "operation-result-shape-merge", "operation-trace", "live-profile-read-coverage", "live-core-read-contract", "result-contract", "result-field-worker-guard", "source-architecture", "no-year-conditionals", "mcp-module-boundaries", "mcp-main-contract",
...
for (const required of [
  ...
  "mcp-api-all-operations", "api-tax-journeys", "operation-schema-catalog", "verification-doc-coverage", "live-core-read-contract", "result-contract", "result-field-worker-guard", "source-architecture", "mcp-module-boundaries", "mcp-main-contract", "repository-privacy", "repository-links", "javascript-syntax", "powershell-syntax",
  ...
  "case-file", "live-script-resource-contract", "sse-process-guard", "workspace-file-cancellation", "api-client-body-abort", "api-client-transport-timeout", "api-local-http-transport", "dist-artifacts",
]) {
