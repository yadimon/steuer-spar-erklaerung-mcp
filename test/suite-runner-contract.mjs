...
const expectedNames = [
  ...
  "akad-parser", "table-combobox-guard", "case-file", "setup-wizard", "pdf-render-helper", "atomic-files", "jsonl-logger", "dist-artifacts", "release-metadata", "native-build-cache", "npm-package", "workspace-containment", "workspace-file-cancellation",
