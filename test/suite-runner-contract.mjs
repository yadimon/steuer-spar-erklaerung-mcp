...
for (const required of [
  ...
  "case-file", "mcp-launcher", "live-script-resource-contract", "sse-process-guard", "workspace-file-cancellation", "api-static-documents", "api-client-body-abort", "api-client-transport-timeout", "api-local-http-transport", "dist-artifacts", "release-metadata", "portable-archive-verification", "portable-release-verification",
]) {
