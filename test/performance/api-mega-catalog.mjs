...
export const MEGA_MUTATION_READBACKS = Object.freeze([
  ...
  mutation("launch-gew-recovery-discard", "launch-and-reads", "dialog_answer", "instances", "the exact recovery prompt is discarded only for the hash-bound regular Gew case"),
  ...
  mutation("reopen-gew-recovery-discard", "table-and-persistence", "dialog_answer", "instances", "the exact recovery prompt is discarded only for the saved hash-bound Gew case"),
  ...
  mutation("close-gew", "est-and-collect", "close", "health", "owned Gew process is no longer running before changing product mode"),
  mutation("launch-est", "est-and-collect", "launch", "dialog_list", "launched ESt PID is ready with a bound main HWND and has no unknown startup dialog"),
  mutation("launch-est-recovery-discard", "est-and-collect", "dialog_answer", "instances", "the exact recovery prompt is discarded only for the hash-bound regular ESt case"),
  mutation("launch-est-startup-dialog", "est-and-collect", "dialog_answer", "dialog_list", "the exact passive ESt startup dialog is gone"),
  mutation("collect-result", "est-and-collect", "collect", "workspace_file_read_text", "complete terminal-page collect JSON is hash-bound, readable and structurally valid"),
  mutation("goto-known-field", "est-and-collect", "goto", "known_page_state", "dynamic person-bound ESt pageId is current"),
  mutation("known-field-write", "est-and-collect", "fill_fields", "known_page_state", "profiled currency field equals the temporary value"),
  mutation("known-field-correction", "est-and-collect", "fill_fields", "known_page_state", "corrected profiled currency value is visible"),
  ...
  mutation("receipt-manager-open-after-link", "receipts", "menu_click", "windows", "the reopened BelegManager starts in its profiled start state after link"),
  mutation("receipt-show-list-after-link", "receipts", "receipt_manager_action", "receipt_manager_list", "synthetic receipt remains unique after link"),
  ...
  mutation("receipt-manager-open-after-unlink", "receipts", "menu_click", "windows", "the reopened BelegManager starts in its profiled start state after unlink"),
  mutation("receipt-show-list-after-unlink", "receipts", "receipt_manager_action", "receipt_manager_list", "synthetic receipt remains unique after unlink"),
