...
export const MEGA_MUTATION_READBACKS = Object.freeze([
  ...
  mutation("launch-gew", "launch-and-reads", "launch", "dialog_list", "launched Gew PID has no unknown startup dialog"),
  mutation("launch-gew-startup-dialog", "launch-and-reads", "dialog_answer", "dialog_list", "the exact passive startup dialog is gone"),
  mutation("goto-vehicle", "vehicle", "goto", "known_page_state", "stable gew.fahrzeug pageId is current"),
  mutation("vehicle-write", "vehicle", "fill_fields", "known_page_state", "both profiled vehicle fields equal temporary values"),
  mutation("vehicle-correction", "vehicle", "fill_fields", "known_page_state", "corrected vehicle description is visible"),
  mutation("vehicle-restore", "vehicle", "fill_fields", "known_page_state", "both vehicle fields equal their original values"),
  ...
  mutation("reopen-gew", "table-and-persistence", "launch", "dialog_list", "reopened Gew PID has no unknown startup dialog"),
  ...
  mutation("close-gew", "receipts", "close", "health", "owned Gew process is no longer running before changing product mode"),
  mutation("launch-est", "receipts", "launch", "dialog_list", "launched ESt PID has no unknown startup dialog"),
  mutation("launch-est-startup-dialog", "receipts", "dialog_answer", "dialog_list", "the exact passive ESt startup dialog is gone"),
