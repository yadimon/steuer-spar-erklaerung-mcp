...
- eine funktionierende vorhandene Installation wiederverwenden, sonst das
  aktuellste passende veröffentlichte Portable-Release aus der kanonischen
  Repository-Releasequelle samt Prüfsumme installieren;
- den vom Release gebündelten Node verwenden, ohne globales Node.js/npm,
  Python, Git oder PowerShell 7 zu installieren;
